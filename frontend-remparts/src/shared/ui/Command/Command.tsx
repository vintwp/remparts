...
function CommandDialog({
  ...
  ...props
}: React.ComponentProps<typeof DialogCommand> & {
  title?: string;
  description?: string;
  className?: string;
  ...
  return (
    <DialogCommand {...props}>
      <DialogCommandHeader className="sr-only">
        <DialogCommandTitle>{title}</DialogCommandTitle>
        <DialogCommandDescription>{description}</DialogCommandDescription>
      </DialogCommandHeader>
      <DialogCommandContent
