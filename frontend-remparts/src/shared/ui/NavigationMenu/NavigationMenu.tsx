...
>(({ className, children, disableViewport, ...props }, ref) => (
...
>(({ className, children, indicator, triggerMode = 'hover', ...props }, ref) => (
  ...
  >
    ...
    {indicator || (
      <ChevronDown
        className="relative top-[1px] h-4 w-4 min-w-4 transition duration-300 group-data-[state=open]:rotate-180"
        aria-hidden="true"
      />
    )}
  </NavigationMenuPrimitive.Trigger>
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ...
    className={cn(
      ...
      data-[motion=to-start]:slide-out-to-left-52 top-0 left-0 w-full md:absolute md:w-auto`,
      className,
    )}
    {...props}
  />
...
>(({ className, wrapperClassName = '', ...props }, ref) => (
  <div className={cn('absolute top-full left-0 flex justify-center', wrapperClassName)}>
