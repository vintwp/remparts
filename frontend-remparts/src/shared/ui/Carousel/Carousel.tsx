    ...
    >
      {Array.from({ length: numberOfSlides }).map((_, i) => (
        <Button
          ...
          variant="outline"
          className={cn(
            'relative h-3 min-h-0 w-3 cursor-pointer rounded-full p-0',
            `border-black/10 bg-black/10 after:absolute after:block after:h-2 after:w-2 after:rounded-full
            after:content-[""]`,
            currentSlide === i && 'after:bg-clr-secondary-3 bg-white',
          )}
