...
export function PasswordRecoveryTemplate({ domain, token }: Props) {
  const confirmationLink = `${domain}/api/auth/recovery/${token}`;
  ...
  return (
    <Tailwind>
      <Html style={font}>
        <Head />
        <Body>
          <Preview>Remparts Reset Password</Preview>
              ...
              <Section className="px-4 text-base">
                <Section className="bg-white px-3">
                  ...
                  <Text className="text-base">
                    Ви надіслали запит на скидання пароля. Щоб встановити новий пароль, перейдіть за
                  ...
                  <Text className="text-base">
                    Якщо ви не надсилали запит на скидання пароля, просто проігноруйте цей лист —
                    змін у вашому обліковому записі не відбудеться.
                  </Text>
